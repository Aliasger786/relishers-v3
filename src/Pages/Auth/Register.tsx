        ...
        <ImageBox />
          <div className="w-full md:w-[30rem]">
            ...
            <ProviderAuth />
              ...
              <p
                className="flex items-center justify-center px-7 py-3 bg-gradient-to-br from-red-400 to-red-500 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-red-700 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg transition duration-150 ease-in-out w-full cursor-pointer"
                onClick={EmailAuth}
              >
                Sign Up
              </p>
